...
public class MainController {
    ...
    private static final Long ROLE_USER_AUTOHORITY_ID = 2L;
    ...
    public String loginError (Model model) {
        ...
        model.addAttribute("errorMsg", "登陆失败或密码错误");
        return "login";
    }
    ...
    public String registerUser (User user) {
        ...
        authorities.add(authorityService.getAuthorityById(ROLE_USER_AUTOHORITY_ID));
